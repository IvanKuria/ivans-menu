...
final class StatusItemController {
    ...
    init(onSettings: @escaping () -> Void, onRestoreIcons: @escaping () -> Void, onQuit: @escaping () -> Void) {
        self.onSettings = onSettings; self.onRestoreIcons = onRestoreIcons; self.onQuit = onQuit
